...
const Navbar = () => {
  return (
    <>
<nav className="navbar navbar-expand-lg bg-color bg-secondary text-uppercase fixed-top" id="mainNav">
            <div className="container">
                <a className="navbar-brand" href="#page-top">LuxeLaneDriving</a>
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li className="nav-item mx-0 mx-lg-1"><a className="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Home</a></li>
                        <li className="nav-item mx-0 mx-lg-1"><a className="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">My Account</a></li>
